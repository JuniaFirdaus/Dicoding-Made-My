package e.juna.mynavigationasynctask.MovieFavoriteContentProvider.provider;
...
import static e.juna.mynavigationasynctask.MovieFavoriteContentProvider.db.DatabaseContract.AUTHORITY;
...
public class NoteProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        noteHelper = new MovieContentHelper(getContext());
        noteHelper.open();
        return true;
    }

...
public class LoaderCariMovie extends AsyncTaskLoader<ArrayList<MovieItems>> {
    private ArrayList<MovieItems> mData;
    private boolean mHasResult = false;

    private String mCariMovie;

    public LoaderCariMovie(final Context context, String cariMovie) {
        super(context);
    ...
    public ArrayList<MovieItems> loadInBackground() {
        ...
        String url = "https://api.themoviedb.org/3/search/movie?api_key="+API_KEY+"&language=en-US&query="+mCariMovie;
